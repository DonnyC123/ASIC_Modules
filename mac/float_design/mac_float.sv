module mac_float #(
  ...
  always_comb begin
    ...
    if (sum_exp_unfl) begin
      sum_frac_raw = normalized_mantissa[FULL_SUM_W-MANTISSA_W:FRAC_W];
      sticky_sum   = |normalized_mantissa[FULL_SUM_W-MANTISSA_W-FRAC_W-2:0];
      guard        = normalized_mantissa[FULL_SUM_W-MANTISSA_W-2-FRAC_W-1];
    end
