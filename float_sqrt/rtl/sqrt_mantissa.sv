module sqrt_mantissa #(
  ...
  localparam TEST_SUB_W  = MANTISSA_W + SIGN_W;

  localparam STAGE_STEPS           = MANTISSA_W / PIPELINE_STAGES;
  localparam REMAINING_STAGE_STEPS = MANTISSA_W - PIPELINE_STAGES * STAGE_STEPS;
