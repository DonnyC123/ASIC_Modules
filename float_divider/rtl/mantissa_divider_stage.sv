// One SRT radix-4 iteration.
// Pure combinational: shifts remainder, selects quotient digit, updates both.
...
#(
  ...
  always_comb begin
    divisor_padded     = $signed({(SIGN_W + GUARD_W + REDUCTION_FACTOR)'(0), divisor_i, REDUCTION_FACTOR'(0)});
    ...
    remainder_o = remainder_shifted - subtrahend;
